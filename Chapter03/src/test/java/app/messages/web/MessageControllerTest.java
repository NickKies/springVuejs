...
public class MessageControllerTest {
  ...
  @Test
  // 작업_단위테스트 중인 상태_예상되는 행동
  //public void getMessages_existingMessages_shouldReturnJsonArray() throws Exception {
  public void 메세지가_제이슨형식으로_리턴된다() throws Exception {
    Message firstMessage = new Message("첫번째 메세지");
    List<Message> allMessages = Arrays.asList(firstMessage);

    when(service.getMessage()).thenReturn(allMessages);
